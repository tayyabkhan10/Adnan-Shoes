...
export default function Checkout() {
  ...
  // NEW: Submission wrapper to handle payment step without touching onSubmit
  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-6xl">
      ...
      {/* NEW: Payment Method Selector (Appears Before Order Details) */}
      <div className="mb-8">
      ...
      {/* Order Details Grid (Disabled/Blurred until payment is selected to prevent URL bypass) */}
